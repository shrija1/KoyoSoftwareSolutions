    ...
    <header id="header" className="fixed-top">
      <div className="container d-flex justify-content-between">
        ...
        <div className="navbarcontainer">
          ...
          <HashLink className="navbarlinks" smooth to="#jobs">
            {WebText.home.navbar.navItems.item4}
          </HashLink>
          <HashLink className="navbarlinks" smooth to="#contact">
            {WebText.home.navbar.navItems.item5}
          </HashLink>
          <a
            style={{ marginTop: "-2px" }}
            href="https://wa.me/9867910690"
            rel="noreferrer"
            target="_blank"
          >
            <i
          ...
          <a
            ...
            href="mailto:koyosoftwaresolutions@gmail.com"
            target="_blank"
            rel="noreferrer"
          >
            {" "}
        ...
        >
          ...
          <li className="drop-down nav-item dropdown" id="secondNavServices">
            ...
            >
              ...
              <Link className="dropdown-item" to="/machineLearning">
      ...
      >
        <div className="modalBody">
          All functionalities can be accessed without having to sign in. The
          button will be made live as we add more features to the site.
        </div>
      </Modal>
    </header>
  );
