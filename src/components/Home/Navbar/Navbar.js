        ...
        <header id="header" className="fixed-top">
            ...
            <div className="container d-flex justify-content-between">
                ...
                <div className="navbarcontainer">
                    ...
                    <div class="dropdown  ">
                        <div className="dropdownbtn dropdown-toggle" smooth to="#d" >Services</div>
                        <div class="dropdown-content">
                            <HashLink className="navbarlinksdropdown" smooth to="#webportfolio" >Web Design</HashLink>
                            <HashLink className="navbarlinksdropdown"  >AI and ML</HashLink>
                            <HashLink className="navbarlinksdropdown" >Learn and Code</HashLink>
                            <HashLink className="navbarlinksdropdown" smooth to="#brandingsols" >Branding Solutions</HashLink>
                        </div>
                        </div>
                      
                  
                    <HashLink className="navbarlinks" smooth to="#jobs" >{WebText.home.navbar.navItems.item4}</HashLink>
                    <HashLink className="navbarlinks" smooth to="#contact" >{WebText.home.navbar.navItems.item5}</HashLink>
                    <a style={{ marginTop:'-5px'}} href="https://wa.me/9867910690" rel="noreferrer" target="_blank"><i style={{ color: '#f2af49', fontSize: '23px' }} className="bi bi-whatsapp"></i></a>  <a style={{ marginTop:'-5px',marginLeft: '20px'}} href="mailto:koyosoftwaresolutions@gmail.com" target="_blank" rel="noreferrer"> <i style={{ color: '#f2af49', paddingLeft: '4%', fontSize: '24px' }} className="bi bi-envelope"></i></a>
                ...
                <ul className="navbar-nav nav-menu" style={{ textAlign: 'left', marginLeft: '15%' }}>
                    ...
                    <li id="about" className="nav-item">
                        ...
                        >
                            ...
                            <HashLink className="navbarlinksdropdown" smooth to="#jobs" >{WebText.home.navbar.navItems.item4}</HashLink>
                        </button>
                    </li>
